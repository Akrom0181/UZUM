...
const (
	...
	ProductService_GetAll_FullMethodName  = "/catalog_service.ProductService/GetAll"
...
type ProductServiceClient interface {
	...
	Delete(ctx context.Context, in *ProductPrimaryKey, opts ...grpc.CallOption) (*Empty3, error)
}
...
func (c *productServiceClient) Delete(ctx context.Context, in *ProductPrimaryKey, opts ...grpc.CallOption) (*Empty3, error) {
	out := new(Empty3)
...
type ProductServiceServer interface {
	...
	Delete(context.Context, *ProductPrimaryKey) (*Empty3, error)
}
...
func (UnimplementedProductServiceServer) Delete(context.Context, *ProductPrimaryKey) (*Empty3, error) {
