...
const (
	ProductCategoryService_Create_FullMethodName  = "/catalog_service.ProductCategoryService/Create"
	ProductCategoryService_GetByID_FullMethodName = "/catalog_service.ProductCategoryService/GetByID"
	ProductCategoryService_GetAll_FullMethodName  = "/catalog_service.ProductCategoryService/GetAll"
	ProductCategoryService_Update_FullMethodName  = "/catalog_service.ProductCategoryService/Update"
	ProductCategoryService_Delete_FullMethodName  = "/catalog_service.ProductCategoryService/Delete"
)
...
type ProductCategoryServiceClient interface {
	...
	Delete(ctx context.Context, in *ProductCategoryPrimaryKey, opts ...grpc.CallOption) (*Empty1, error)
}
...
func (c *productCategoryServiceClient) Delete(ctx context.Context, in *ProductCategoryPrimaryKey, opts ...grpc.CallOption) (*Empty1, error) {
	out := new(Empty1)
...
type ProductCategoryServiceServer interface {
	...
	Delete(context.Context, *ProductCategoryPrimaryKey) (*Empty1, error)
}
...
func (UnimplementedProductCategoryServiceServer) Delete(context.Context, *ProductCategoryPrimaryKey) (*Empty1, error) {
