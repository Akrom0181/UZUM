...
const (
	ProductReviewService_Create_FullMethodName  = "/catalog_service.ProductReviewService/Create"
	ProductReviewService_GetByID_FullMethodName = "/catalog_service.ProductReviewService/GetByID"
	ProductReviewService_GetAll_FullMethodName  = "/catalog_service.ProductReviewService/GetAll"
	ProductReviewService_Update_FullMethodName  = "/catalog_service.ProductReviewService/Update"
	ProductReviewService_Delete_FullMethodName  = "/catalog_service.ProductReviewService/Delete"
)
...
type ProductReviewServiceClient interface {
	...
	Delete(ctx context.Context, in *ProductReviewPrimaryKey, opts ...grpc.CallOption) (*Empty2, error)
}
...
func (c *productReviewServiceClient) Delete(ctx context.Context, in *ProductReviewPrimaryKey, opts ...grpc.CallOption) (*Empty2, error) {
	out := new(Empty2)
...
type ProductReviewServiceServer interface {
	...
	Delete(context.Context, *ProductReviewPrimaryKey) (*Empty2, error)
}
...
func (UnimplementedProductReviewServiceServer) Delete(context.Context, *ProductReviewPrimaryKey) (*Empty2, error) {
